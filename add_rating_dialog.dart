...
void main() {
  ...
  if (!content.contains('class RatingDialog')) {
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(color: const Color(0xFF1BCA75).withValues(alpha: 0.1), shape: BoxShape.circle),
...
''';
    content = content.substring(0, injectPos) + ratingDialogCode + '\n}';
    file.writeAsStringSync(content);
    print('Added RatingDialog to my_orders_screen.dart');
  } else {
    print('RatingDialog already exists');
  }
}
